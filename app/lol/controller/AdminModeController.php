...
// dump($list);die;
    ...
    public function addPost()
    {
        ...
        $this->success('提交成功',url('AdminMode/edit',['id'=>$smodel->id]));
    }
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            ...
            if (!empty($res)) {
                Db::name('lol_mode')->where(['id'=>$id])->update(['status'=>0]);
    ...
    {
        parent::listOrders(Db::name('lol_mode'));
        $this->success('排序更新成功！','');
    }
