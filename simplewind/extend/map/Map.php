...
class Map
{
    ...
    * @return mixed
    */
    private static function async($url, $params = array(), $encode = true, $method = self::REQ_GET)
    {
        $ch = curl_init();
    ...
    * @throws Exception
    */
    public static function locationByGPS($lng, $lat)
    {
        $params = array(
            'coordtype' => 'wgs84ll',
            'location' => $lat . ',' . $lng,
        ...
        if ($data['status'] == 0){
            ...
            $result = array(false,$data['message']);
        }
